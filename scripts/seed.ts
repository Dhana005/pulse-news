...
const CATEGORIES = [
  ...
  { key: "business", label: "வணிகம்", sort_order: 6 },
  { key: "technology", label: "தொழில்நுட்பம்", sort_order: 7 },
  { key: "lifestyle", label: "லைஃப் ஸ்டைல்", sort_order: 8 },
];
...
const HEADLINE_POOL: Record<string, string[]> = {
  ...
  business: [
    "பங்குச் சந்தையில் இன்றைய நிலவரம்",
    "புதிய தொழில் முதலீடு அறிவிப்பு",
    "ரிசர்வ் வங்கியின் புதிய கொள்கை",
    "பொருளாதார வளர்ச்சி விகிதம் அறிக்கை",
    "தங்கம், வெள்ளி விலை நிலவரம்",
    "ஸ்டார்ட்அப் நிறுவனத்திற்கு புதிய நிதி உதவி",
    "ஏற்றுமதி வர்த்தகத்தில் வளர்ச்சி",
    "பட்ஜெட் தொடர்பான எதிர்பார்ப்புகள்",
  ],
  technology: [
    "புதிய ஸ்மார்ட்போன் வெளியீடு",
    "செயற்கை நுண்ணறிவு தொழில்நுட்ப முன்னேற்றம்",
    "இணையதள பாதுகாப்பு குறித்த எச்சரிக்கை",
    "புதிய செயலி வெளியீடு அறிவிப்பு",
    "தொழில்நுட்ப நிறுவனத்தின் புதிய தயாரிப்பு",
    "5ஜி நெட்வொர்க் விரிவாக்கம்",
    "மின்னணு சாதனங்களுக்கான புதிய தரநிலை",
    "தொழில்நுட்ப துறையில் வேலைவாய்ப்பு அறிவிப்பு",
  ],
  lifestyle: [
    "ஆரோக்கியமான வாழ்க்கை முறை குறிப்புகள்",
    "பயண அனுபவம் குறித்த கட்டுரை",
    "உணவு வகைகள் தயாரிக்கும் முறை",
    "பாரம்பரிய பண்டிகை கொண்டாட்டங்கள்",
    "ஆடை அலங்காரப் போக்குகள்",
    "வீட்டு அலங்காரம் குறித்த யோசனைகள்",
