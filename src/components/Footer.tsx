...
const SOCIAL_ICONS = [
  { label: "Facebook", path: "M14 9h3V6h-3c-1.66 0-3 1.34-3 3v2H9v3h2v6h3v-6h3l1-3h-4v-2c0-.55.45-1 1-1z" },
  { label: "X", path: "M4 4l16 16M20 4L4 20" },
  { label: "Instagram", path: "M7 3h10a4 4 0 0 1 4 4v10a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V7a4 4 0 0 1 4-4zm5 5a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm5-1.2a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" },
  { label: "YouTube", path: "M22 12s0-3.2-.4-4.7a2.9 2.9 0 0 0-2-2C17.9 5 12 5 12 5s-5.9 0-7.6.3a2.9 2.9 0 0 0-2 2C2 8.8 2 12 2 12s0 3.2.4 4.7a2.9 2.9 0 0 0 2 2C6.1 19 12 19 12 19s5.9 0 7.6-.3a2.9 2.9 0 0 0 2-2C22 15.2 22 12 22 12zM10 15.5v-7l6 3.5-6 3.5z" },
];
  ...
  return (
    <footer style={{ background: "#0f2440", color: "rgba(255,255,255,0.85)" }}>
      <div className="max-w-[1240px] w-full mx-auto px-4 md:px-10 pt-10 md:pt-14 pb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr] gap-8 md:gap-6 mb-10">
          <div className="flex flex-col gap-3.5">
            <div className="flex items-center gap-2">
              ...
              <span className="font-brand font-bold text-[17px] text-white">PulseNews</span>
            </div>
          ...
          {LINK_COLUMNS.map((col) => (
            <div key={col.heading} className="flex flex-col gap-2.5">
              <h3 className="text-[13.5px] font-bold text-white m-0">{col.heading}</h3>
              {col.links.map((link) => (
                <a key={link.label} href={link.href} className="text-[13.5px] opacity-75 hover:opacity-100">
                  {link.label}
                </a>
              ))}
            </div>
          ...
          <div className="flex flex-col gap-2.5">
            <h3 className="text-[13.5px] font-bold text-white m-0">மொபைல் ஆப்</h3>
            <span
              aria-hidden="true"
        ...
        >
          <span>© {new Date().getFullYear()} PulseNews. அனைத்து உரிமைகளும் பாதுகாக்கப்பட்டவை.</span>
